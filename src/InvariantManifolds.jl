...
# construct the time-T-map for mixed types of non-smooth ODE systems, 
#e.g., impact&&piecewise smooth, filippov&&impact.
# include("mixed.jl")

# the one dimensional non-smooth manifold algorithm
include("nonsmooth-one.jl")

# vector fields's two dimensional manifolds
